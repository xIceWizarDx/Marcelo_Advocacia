...
const ContactConsultationHub = () => {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent(
      "Olá! Gostaria de agendar uma consulta jurídica. Poderia me ajudar com informações sobre disponibilidade e procedimentos?"
    );
  ...
  const handleEmailClick = () => {
    const subject = encodeURIComponent('Solicitação de Consulta Jurídica');
    const body = encodeURIComponent(
      'Olá Dr. Marcelo,\n\nGostaria de agendar uma consulta jurídica.\n\nPor favor, entre em contato comigo para discutirmos os detalhes.\n\nObrigado(a)!'
    );
    window.location.href = `mailto:marcelobaiaadvogado@gmail.com?subject=${subject}&body=${body}`;
  };
